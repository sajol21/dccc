    ...
    <footer className="glass-effect mt-24 border-t border-accent/50">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <h3 className="text-sm font-heading tracking-wider uppercase text-text-primary">Quick Links</h3>
            <ul className="mt-4 space-y-2">
              <li><NavLink to="/about" className="text-sm text-text-secondary hover:text-text-primary">About Us</NavLink></li>
              <li><NavLink to="/showcase" className="text-sm text-text-secondary hover:text-text-primary">Showcase</NavLink></li>
          ...
          {/* Column 3: Contact */}
          <div>
            <h3 className="text-sm font-heading tracking-wider uppercase text-text-primary">Contact Us</h3>
            <ul className="mt-4 space-y-2 text-sm text-text-secondary">
              <li>{footerSettings.contact.address}</li>
              <li>Email: {footerSettings.contact.email}</li>
              <li>Phone: {footerSettings.contact.phone}</li>
            </ul>
          </div>
          
          {/* Column 4: Social */}
          <div>
            <h3 className="text-sm font-heading tracking-wider uppercase text-text-primary">Follow Us</h3>
