        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li><NavLink to="/about" className="text-sm text-text-secondary hover:text-white">About Us</NavLink></li>
              <li><NavLink to="/showcase" className="text-sm text-text-secondary hover:text-white">Showcase</NavLink></li>
              <li><NavLink to="/leaderboard" className="text-sm text-text-secondary hover:text-white">Leaderboard</NavLink></li>
              <li><NavLink to="/resources" className="text-sm text-text-secondary hover:text-white">Resources</NavLink></li>
            </ul>
          </div>

          {/* Column 3: Contact */}
          <div>
            <h3 className="text-sm font-semibold text-text-primary tracking-wider uppercase">Contact Us</h3>
            <ul className="mt-4 space-y-2 text-sm text-text-secondary">
              <li>Dhaka College, Dhaka-1205</li>
              <li>Email: contact@dccc.bd</li>
          ...
          {/* Column 4: Social */}
          <div>
            <h3 className="text-sm font-semibold text-text-primary tracking-wider uppercase">Follow Us</h3>
